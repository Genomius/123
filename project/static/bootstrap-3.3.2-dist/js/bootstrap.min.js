...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=e9eb5cd94484d7455410)
 * Config saved to config.json and https://gist.github.com/e9eb5cd94484d7455410
 */
...
+function (t) {
    ...
    i.VERSION = "3.3.2", i.TRANSITION_DURATION = 600, i.DEFAULTS = {
        ...
        return this.$items.eq(s)
         ...
         var curSlider = $('#carousel-example-generic ol li[class="no-active active"]').attr('data-slider');
            $('.right-images-block[data-slide='+ curSlider +']').removeClass('hidden-block');
